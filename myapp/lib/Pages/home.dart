    ...
    return GestureDetector(
      onTap: () {
        _imageAnimationController.forward().then((value) {
          ...
          _imageAnimationController.reset(); // Reset the animation after navigation
        });
      },
      child: Scaffold(
        backgroundColor: Color.fromARGB(255, 178, 155, 247),
        appBar: AppBar(
          title: const Text(
            'Random App',
            style: TextStyle(
          ...
          centerTitle: true,
          backgroundColor: Color.fromARGB(255, 40, 15, 65),
        ),
        body: Center(
          child: Column(
...
Route _createRoute() {
  return PageRouteBuilder(
    ...
    transitionsBuilder: (context, animation, secondaryAnimation, child) {
      ...
      var slideOutTween = Tween<Offset>(begin: begin, end: end).chain(CurveTween(curve: curve));
      var slideInTween = Tween<Offset>(begin: const Offset(0.0, 1.0), end: Offset.zero).chain(CurveTween(curve: curve));
